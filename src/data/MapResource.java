...
public class MapResource extends Resource {
	...
	public static MapResource create(){		
		...
		Stone				 = new MapResource(1203, new Hitbox(0, 0, Map.DEFAULT_SQUARESIZE, Map.DEFAULT_SQUARESIZE), true, 100, new EdgeBlockData("Stone"		, new Color( 71, 71, 71), new Color( 76, 76, 76), new Color( 91, 91, 91), new Color(104,104,104))	, false, Sprites.Blocks.getSpriteSheet(), AnimationType.NONE 	, 0,  new ResourcePart[]{}, ItemType.Stone	, 1,  1);	
		Iron_Ore			 = new MapResource(1204, new Hitbox(0, 0, Map.DEFAULT_SQUARESIZE, Map.DEFAULT_SQUARESIZE), true, 100, new EdgeBlockData("Iron_Ore"	, new Color( 71, 71, 71), new Color( 76, 76, 76), new Color( 91, 91, 91), new Color(104,104,104))	, false, Sprites.Blocks.getSpriteSheet(), AnimationType.NONE 	, 0,  new ResourcePart[]{}, ItemType.Stone	, 1, 20);		
		Gold_Ore			 = new MapResource(1205, new Hitbox(0, 0, Map.DEFAULT_SQUARESIZE, Map.DEFAULT_SQUARESIZE), true, 100, new EdgeBlockData("Gold_Ore"	, new Color( 71, 71, 71), new Color( 76, 76, 76), new Color( 91, 91, 91), new Color(104,104,104))	, false, Sprites.Blocks.getSpriteSheet(), AnimationType.NONE 	, 0,  new ResourcePart[]{}, ItemType.Stone	, 1, 21);	
		Silver_Ore			 = new MapResource(1206, new Hitbox(0, 0, Map.DEFAULT_SQUARESIZE, Map.DEFAULT_SQUARESIZE), true, 100, new EdgeBlockData("Silver_Ore", new Color( 71, 71, 71), new Color( 76, 76, 76), new Color( 91, 91, 91), new Color(104,104,104))	, false, Sprites.Blocks.getSpriteSheet(), AnimationType.NONE 	, 0,  new ResourcePart[]{}, ItemType.Stone	, 1, 22);	
		Coal				 = new MapResource(1207, new Hitbox(0, 0, Map.DEFAULT_SQUARESIZE, Map.DEFAULT_SQUARESIZE), true, 100, new EdgeBlockData("Coal"		, new Color( 71, 71, 71), new Color( 76, 76, 76), new Color( 91, 91, 91), new Color(104,104,104))	, false, Sprites.Blocks.getSpriteSheet(), AnimationType.NONE 	, 0,  new ResourcePart[]{}, ItemType.Stone	, 1, 23);	
